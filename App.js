...
import { 
  ...
  MapPin, Phone, Mail, Printer, Shield
} from 'lucide-react';
...
// --- FIREBASE CONFIG (Using same for quick start) ---
...
function App() {
    ...
    const [activeTab, setActiveTab] = useState('active'); // active/closed cases
        ...
        <div className="flex h-screen bg-slate-50 font-sans text-slate-800">
            ...
            <aside className="w-64 bg-navy-900 text-white flex flex-col shadow-2xl">
                ...
                <div className="p-6 border-t border-navy-800">
                    <div className="bg-navy-800 rounded-xl p-4 flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-gold-500 flex items-center justify-center text-navy-900 font-bold">
                            AL
                        </div>
                        <div>
                            <p className="text-sm font-bold text-white">Ali Lawyer</p>
                            <p className="text-xs text-slate-400">Senior Advocate</p>
                        </div>
                    </div>
                </div>
            </aside>
...
// Icon Import Helper (React Lucide)
